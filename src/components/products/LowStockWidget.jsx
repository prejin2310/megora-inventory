...
export default function LowStockWidget() {
  ...
  // ✅ Fix: default to table view on mobile
  useEffect(() => {
    const handleResize = () => {
...
.stock-critical { background: #fee2e2; color: #b91c1c; } /* light red */
.stock-low { background: #fef3c7; color: #92400e; }      /* light amber */
.stock-ok { background: #dcfce7; color: #065f46; }       /* light green */
  ...
  /* ✅ Stock color rules */
  .stock-critical { color: #dc2626; font-weight: 700; } /* red */
  .stock-low { color: #d97706; font-weight: 600; }     /* orange */
  .stock-ok { color: #059669; font-weight: 600; }      /* green */
  ...
  /* Critical modal ... (keep your existing modal styles unchanged) */
